...
3. 【进阶选学】编程工具：各种 AI 编程工具的介绍和选择（按需学）
4. 【进阶选学】项目实战：10 多个完整项目案例（边做边学）
5. 【进阶选学】经验技巧：高手的技巧和方法（提升效率）
6. 【进阶选学】编程学习：编程技术入门和进阶知识（按需学）
7. 【进阶选学】资源宝库：工具、模板、资源合集（随时查阅）
8. 【进阶选学】AI 大模型原理入门：搞懂原理，更好地驾驭 AI（按需学）
9. 【进阶选学】鱼皮的 AI 编程实战视频课：系统学习 AI 编程的付费视频课程
